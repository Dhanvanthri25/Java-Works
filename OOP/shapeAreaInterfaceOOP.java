...
public class shapeAreaInterfaceOOP implements Area
{
public void Circle()
{
...
public void Square(){
	...
	System.out.println("Enter the length of the side square");
...
public static void main(String[] args){
	shapeAreaInterfaceOOP geometry=new shapeAreaInterfaceOOP();
	geometry.Circle();
	geometry.Square();
	geometry.Rectangle();
	geometry.Triangle();
